...
Ship greenlit features to `done` with passing tests and a lead review, inside the weekly token allowance.
...
Every `done` item carries: test log path, review note path.
