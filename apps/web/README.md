# @gantry/web (not yet implemented — build-order step 5)
...
#FBF3E4, ok #2E9E64, bad #C64A3A. Bricolage Grotesque / Instrument Sans /
IBM Plex Mono. Amber means exactly one thing: waiting on a human.

Later: Tauri wrapper for tray + native notifications (needs-you items).
